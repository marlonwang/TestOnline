<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mixing.aspx.cs" Inherits="mixing" %>
                 ...
                 <ItemTemplate>
                    <table style="margin-top:20px;">
                       <tr><td  id="list1"></td><td  id="list2"><%# Container.ItemIndex+1%>&nbsp;<img src="image/ask.jpg" alt="???" />&nbsp;&nbsp;</td>
                           <td ><span style="color:#D15307">目的：</span>&nbsp;&nbsp;
                           <asp:Label ID="Label4" runat="server" Text="考查管理学计算题相关知识" Visible="True"></asp:Label></td></tr>
                       
                       <tr><td  id="list1"></td><td id="list2"></td>
                           <td ><span style="color:#D15307">资料：</span>&nbsp;&nbsp;<asp:Label ID="itemda1Label" runat="server" Text='<%# Eval("itemwt") %>' /></td></tr>
