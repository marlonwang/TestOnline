<%@ Page Language="C#" AutoEventWireup="true" CodeFile="compute.aspx.cs" Inherits="compute" %>
                 ...
                 <ItemTemplate>
                    <table style="margin-top:20px;">
                       <tr><td  id="list1"></td><td  id="list2"><%# Container.ItemIndex+1%>&nbsp;<img src="image/ask.jpg" alt="???" />&nbsp;&nbsp;</td>
                           <td ><span style="color:#D15307">目的：</span>&nbsp;&nbsp;<asp:Label ID="itemwtLabel" runat="server" Text='<%# Eval("item_aim") %>' />
                           <asp:Label ID="Label4" runat="server" Text="考查管理学计算题相关知识" Visible="False"></asp:Label></td></tr>
                       
                       <tr><td  id="list1"></td><td id="list2"></td>
                           <td ><span style="color:#D15307">资料：</span>&nbsp;&nbsp;<asp:Label ID="itemda1Label" runat="server" Text='<%# Eval("item_data") %>' /></td></tr>
                           
                       <tr><td id="list1"></td><td id="list2"></td>
                           <td ><span style="color:#D15307">要求：</span>&nbsp;&nbsp;<asp:Label ID="itemda3Label" runat="server" Text='<%# Eval("item_require") %>' /></td></tr>
                           
                       <tr><td  id="Td1"></td><td id="Td2"></td><td colspan='2'>
