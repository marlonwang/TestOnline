<%@ Page Language="C#" AutoEventWireup="true" CodeFile="filling.aspx.cs" Inherits="filling" %>
                 ...
                 <ItemTemplate>
                    <table style="margin-top:20px;">
                       <tr><td  id="list1"></td><td  id="list2"><%# Container.ItemIndex+1%>&nbsp;<img src="image/ask.jpg" alt="???" />&nbsp;&nbsp;</td>
                           <td ><asp:Label ID="itemwtLabel" runat="server" Text='<%# Eval("itemwt") %>' />
                           <asp:Image ID="Image1" runat="server" Visible="False" /></td></tr>
                       <tr><td  id="list1"></td><td  id="list2"></td><td style="color:#C1D635">【说明】：多个空之间的答案以、隔开</td></tr>    
                       <tr><td  id="list1"></td><td id="list2"></td>
                           <td ><asp:Label ID="AnsLabel" runat="server" Text="答案： " Visible="False" ForeColor="#3333CC"></asp:Label>
                           <asp:Label ID="answerLabel" runat="server" Text='<%# Eval("answer") %>' ForeColor="Red" Visible="False" /></td></tr>
                           
                       <tr><td  id="list1"></td><td id="list2"></td>
                           
                           <td >填写答案：
                               <asp:TextBox ID="TextBox1" runat="server" Height="18px" Width="150px"></asp:TextBox></td></tr>
